...
***Installing on Ubuntu 16.04 pre-requisites***
```
# Dependencies
...
e.g.: `install.packages(c("dplyr", "tidyr", "ggplot2", "rmarkdown", "plotly", "flexdashboard", "maps", "pandoc", "leaflet", "maptools", "devtools"))`
