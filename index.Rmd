...
### Clarifications and corrections (9/17/18)

Since the original publication of this report, several sections have been updated for clarity and correctness.
...
- Use of Force: Use "increase" and "decrease" consistently instead of approximating trends as "flat". Ho longer assert that the increase in force between 2014 to 2015 is solely attributable to new reporting rules given that rise continues for UOF through 2016.
...
The first question listed six areas of concern. Each respondent was allowed to select zero or more concerns that applied to them. Those six areas were: “Quality of Homicide Investigations, The Treatment of Juveniles, Officer Response Time, Human Rights Violations, Treatment of Crime Victims, or Other.” Each area is discussed individually below:


Row {data-height=520}
-------------------------------------
### Concerned with homicide investigations
Of the 886 people that answered question #1 relating to homicide investigations, 51.7% stated that they are concerned with NOPD's homicide investigations.
```{r, fig.width = 3, fig.height = 3}
p.survey.pies[[1]]
```

### Concerned with treatment of juveniles
Of the 886 people that answered question #1 relating to treatment of juveniles, 56.5% stated that they are concerned with NOPD's treatment of juveniles.
```{r, fig.width = 3, fig.height = 3}
p.survey.pies[[2]]
```

### Concerned with response time
Of the 886 people that answered question #1 relating to officer response time, 65% stated they are concerned with NOPD's officer response time.
```{r, fig.width = 3, fig.height = 3}
p.survey.pies[[3]]
```
...
Of the 886 people that answered question #1 relating to human rights violations, 60.3% stated that they are concerned with NOPD's human rights violations.
```{r, fig.width = 3, fig.height = 3}
p.survey.pies[[4]]
```

### Concerned with crime victim
Of the 886 people that answered question #1 relating to treatment of crime victims, 45.6% stated that they are concerned with NOPD's treatment of crime victims.
```{r, fig.width = 3, fig.height = 3}
p.survey.pies[[5]]
```

### Concerned other
Of the 886 people that answered question #1 relating to other areas, 10.2% stated that they have other areas of concern that were not listed.
```{r, fig.width = 3, fig.height = 3}
p.survey.pies[[6]]
```
...
Of the 886 people that answered question #2 relating to helping the public understand NOPD better and identifying areas of NOPD improvement, 60.5% stated that if they were Police Monitor, one of their priorities would be helping the public understand NOPD better and identifying areas of NOPD improvement.
...
Of the 886 people that answered question #2 relating to helping NOPD leadership see and
correct problems, 59.3% stated that if they were Police Monitor, one of their priorities would be
...
successes and mistakes, 43.6% stated that if they were Police Monitor, one of their priorities would be
...
### Prioritize other
Of the 886 people that answered question #2 relating to other priorities, 5.76% stated that if
they were Police Monitor, one of their priorities would be something other than the options provided
