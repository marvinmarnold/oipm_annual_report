...
* Of those, 20 officers account for 20% of force. Unfair to say “bad apples” because many of those officers are in special operations (see below).
...
Row
-------------------------------------
### UOF by Indivdual Gender and Race
```{r, fig.width = 5, fig.height = 4}
p.uof.by.victim.sex.race
```

### UOF by Female Indivdiual Race
```{r, fig.width = 5, fig.height = 4}
...
The first question listed six areas of concern that the community could choose was of the greatest concern to them. Those six areas were: “Quality of Homicide Investigations, The Treatment of Juveniles, Officer Response Time, Human Rights Violations, Treatment of Crime Victims, or Other.” Each area is discussed individually below:


Row
-------------------------------------
### Concerned with homicide investigations
Of the 886 people that answered question #1 relating to homicide investigations, 51.7% stated that homicide investigations are their greatest concern about NOPD.
```{r, fig.width = 3, fig.height = 3}
p.survey.pies[[1]]
```

### Concerned with treatment of juveniles
Of the 886 people that answered question #1 relating to treatment of juveniles, 56.5% stated that the treatment of juveniles is their greatest concern about NOPD.
```{r, fig.width = 3, fig.height = 3}
p.survey.pies[[2]]
```

### Concerned with response time
Of the 886 people that answered question #1 relating to officer response time, 65% stated that Officer Response Time is their greatest concern about NOPD.
```{r, fig.width = 3, fig.height = 3}
p.survey.pies[[3]]
```
...
Of the 886 people that answered question #1 relating to human rights violations, 60.3% stated that human rights violations are their greatest concern about NOPD.
```{r, fig.width = 3, fig.height = 3}
p.survey.pies[[4]]
```

### Concerned with crime victim
Of the 886 people that answered question #1 relating to treatment of crime victims, 45.6% stated that treatment of crime victims is their greatest concern about NOPD.
```{r, fig.width = 3, fig.height = 3}
p.survey.pies[[5]]
```

### Concerned other
Of the 886 people that answered question #1 relating to other areas, 10.2% stated that other areas were their greatest concern about NOPD. Of those “other” responses, some of the most common were “all of the above”, “Corruption”, “Everything”, “Need more police”, and “Treatment of…” different demographic groups including “youth”, “immigrants”, “blacks”, “women”, “domestic violence victims”.
```{r, fig.width = 3, fig.height = 3}
p.survey.pies[[6]]
```
...
Of the 886 people that answered question #2, 68.1% stated that if they were Police Monitor their priority would be cleaning out the bad apples and making sure NOPD officers were punished for wrongdoing.
...
Of the 886 people that answered question #2 relating to helping the public understand NOPD better and identifying areas of NOPD improvement, 60.5% stated that if they were Police Monitor their priority would be helping the public understand NOPD better and identifying areas of NOPD improvement.
