...
Row 
-------------------------------------
### Use of force by year {data-height=800}
...
### FTN & UOF in 2017 by month {data-height=800}
...
Row
-------------------------------------
### Force by type and effectiveness {data-height=1000}
...
### NOPD's determination of unauthorized force {data-height=1000}
...
paste(top.5.ftn.num.missing, "are mising from the DB suppied to OIPM from NOPD")
...
paste(top.5.uof.num.missing, "are mising from the DB suppied to OIPM from NOPD")
...
paste(top.10.ftn.num.missing, "are mising from the DB suppied to OIPM from NOPD")
...
paste(top.10.uof.num.missing, "are mising from the DB suppied to OIPM from NOPD")
...
paste(top.20.ftn.num.missing, "are mising from the DB suppied to OIPM from NOPD")
...
paste(top.20.uof.num.missing, "are mising from the DB suppied to OIPM from NOPD")
